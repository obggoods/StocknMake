...
create or replace function public.apply_manual_settlement_inventory(p_settlement_id uuid)
...
revoke all on function public.create_manual_settlement_with_inventory(uuid,text,numeric,jsonb) from public;
grant execute on function public.create_manual_settlement_with_inventory(uuid,text,numeric,jsonb) to authenticated;
revoke all on function public.apply_manual_settlement_inventory(uuid) from public;
grant execute on function public.apply_manual_settlement_inventory(uuid) to authenticated;
